...
Rails.application.configure do
  ...
  if ENV['REDIS_HOST'].present?
    ...
    redis_url = "#{protocol}://#{auth}#{ENV['REDIS_HOST']}:#{ENV['REDIS_PORT']}/1"
  ...
  config.action_mailer.default_url_options = { host: "apoloconcursos.com.br" }
  ...
  Rails.application.routes.default_url_options[:host] = 'apoloconcursos.com.br'
