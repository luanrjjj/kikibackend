class Disciplina < SeedMigration::Migration
  def up
    ...
    # Use a dynamic class to avoid conflict with the actual Disciplina model
    model = Class.new(ActiveRecord::Base) { self.table_name = 'disciplinas' }

    disciplinas.each do |nome|
